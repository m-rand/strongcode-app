/**
 * Prompt v2.3 — block-first PlanStrong (2026-02-27)
 *
 * Goal:
 * - Reduce excessive zone switching without rigid hard caps
 * - Keep PlanStrong logic: pyramid/half-pyramid with ladders embedded
 * - Emphasize top-weight options A/B/C and practical barbell flow
 */

export const metadata = {
  id: 'v2_3',
  label: 'v2.3 — block-first',
  tags: ['planstrong', 'block-flow', 'less-switching', 'top-options'],
  createdAt: '2026-02-27T12:00:00',
  description: 'Block-first session flow: build contiguous zone blocks inside pyramid/half-pyramid, with PlanStrong options A/B/C for top-weight organization.',
}
...
- Prefer 4,6,4,6 over 5,5,5,5 when both are feasible.
